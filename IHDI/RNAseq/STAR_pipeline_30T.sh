...
#SBATCH -N 1
#SBATCH -c 1
#SBATCH -o output_STAR_30T.txt
#SBATCH -e error_output_STAR_30T.txt
#SBATCH -J 30T_STAR
#SBATCH -p normal
...
#trim_galore -q 20 --illumina --stringency 6 --fastqc -o /home/a-m/kschach2/IHDI/RNAseq/adapter_trimmed/ /home/a-m/kschach2/IHDI/RNAseq/T30_CATGGATC_L00M_R1_001.fastq.gz

#trim A-tails
#trim_galore -q 20 --stringency 6 -a AAAAAAAAAAAAA -o /home/a-m/kschach2/IHDI/RNAseq/A_trimmed /home/a-m/kschach2/IHDI/RNAseq/adapter_trimmed/T30_CATGGATC_L00M_R1_001_trimmed.fq.gz

#trim T-tails
#trim_galore -q 20 --stringency 6 -a TTTTTTTTTTTTT --fastqc -o /home/a-m/kschach2/IHDI/RNAseq/final_trimmed /home/a-m/kschach2/IHDI/RNAseq/A_trimmed/T30_CATGGATC_L00M_R1_001_trimmed_trimmed.fq.gz

#1st pass alignment
#STAR --runThreadN 1 --genomeDir /home/a-m/kschach2/new_human_assembly/Star_index --outFileNamePrefix /home/a-m/kschach2/IHDI/RNAseq/aligned/30T_ --quantMode GeneCounts --outSAMtype BAM SortedByCoordinate --readFilesIn /home/a-m/kschach2/IHDI/RNAseq/final_trimmed/T30_CATGGATC_L00M_R1_001_trimmed_trimmed_trimmed.fq.gz --readFilesCommand zcat --sjdbGTFtagExonParentGene gene --sjdbGTFfile /home/a-m/kschach2/new_human_assembly/gene_set/Homo_sapiens.GRCh38.91.gtf --sjdbOverhang 149

#remove Y from SJ.out.tab
grep -vw Y /home/a-m/kschach2/IHDI/RNAseq/aligned/30T_SJ.out.tab > /home/a-m/kschach2/IHDI/RNAseq/SJ_female/30T_SJ.out.tab
...
--outFileNamePrefix /home/a-m/kschach2/IHDI/RNAseq/STAR_2_pass/30T_ \
--quantMode TranscriptomeSAM GeneCounts \
--outSAMtype BAM SortedByCoordinate \
--readFilesIn /home/a-m/kschach2/IHDI/RNAseq/final_trimmed/T30_CATGGATC_L00M_R1_001_trimmed_trimmed_trimmed.fq.gz \
--readFilesCommand zcat \
--sjdbGTFfile /home/a-m/kschach2/new_human_assembly/gene_set/Homo_sapiens.GRCh38.91.gtf \
--sjdbOverhang 149

#determine chromosome coverage
for i in /home/a-m/kschach2/IHDI/RNAseq/STAR_2_pass/30T_Aligned.sortedByCoord.out.bam; do echo $i; samtools index $i; done;
for i in /home/a-m/kschach2/IHDI/RNAseq/STAR_2_pass/30T_Aligned.sortedByCoord.out.bam; do echo $i; samtools idxstats $i > /home/a-m/kschach2/IHDI/RNAseq/coverage/30T_chromosomes.txt; done;

#determine average coverage
samtools mpileup /home/a-m/kschach2/IHDI/RNAseq/STAR_2_pass/30T_Aligned.sortedByCoord.out.bam | awk '($1 != "MT")' | awk '{ count++ ; SUM += $4 } END { print "Total: " SUM "\t" "Nucleotides: " count "\t" "Average_coverage: " SUM/count }' > /home/a-m/kschach2/IHDI/RNAseq/coverage/30T_coverage.out

#alignment metrics
java -jar $EBROOTPICARD/picard.jar CollectRnaSeqMetrics \
I=/home/a-m/kschach2/IHDI/RNAseq/STAR_2_pass/30T_Aligned.sortedByCoord.out.bam \
O=/home/a-m/kschach2/IHDI/RNAseq/metrics/30T.RNA_Metrics \
...
CHART_OUTPUT=/home/a-m/kschach2/IHDI/RNAseq/metrics/30T.pdf
...
--calc-pme --calc-ci \
--seed-length 5 \
--alignments /home/a-m/kschach2/IHDI/RNAseq/STAR_2_pass/30T_Aligned.toTranscriptome.out.bam \
/home/a-m/kschach2/new_human_assembly/RSEM/Homo_sapiens_star \
/home/a-m/kschach2/IHDI/RNAseq/RSEM/30T_
